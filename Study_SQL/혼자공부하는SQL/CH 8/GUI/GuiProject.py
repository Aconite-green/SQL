...
def selectData():
    ...
    strData3.append("User Email");  strData2.append("Born")
    ...
    while(True):
        ...
        root.title("Complete GUI Program")
        ...
        btnSelect = Button(edtFrame, text="show", command = selectData)
        ...
        def insertData():
            ...
            sql = "INSERT INTO usrTable VALUES('data1', 'data2', 'data3', data4)"
            cur.execute(sql)

            conn.commit()
            conn.close()

            messagebox.showinfo('Sucess', 'Put data')